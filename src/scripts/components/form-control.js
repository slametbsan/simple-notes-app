...
class FormControl extends HTMLElement {
    static observedAttributes = ["type", "input-name", "label", "placeholder", "description", "min-length"];
...
customElements.get("form-control") || customElements.define("form-control", FormControl);
